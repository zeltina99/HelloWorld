...
/*
	...
	정확하게 이야기하면 "값이 같은지를 비교하는 ==, <=, >=를 조심해서 사용해야 한다." 입니다.
*/

/*
	제어문
	- 프로그램의 흐름을 제어하는 문
		-조건문: 조건에 따라 프로그램의 흐름을 변경
			if, else, if
			switch문 (case:1, break;)
			삼항 연산자
...
/*
	논리 연산자
	- bool값을 받아 bool로 된 결과
	&& (And) : 둘 다 true여야 true다. 둘 중 하나라도 false면 false다.
	|| (Or)	 : 둘 중 하나라도 true면 true다. 둘 다 false면 false다.
	! (Not)	 : true면 false로, false면 true로 바꾼다.
*/
